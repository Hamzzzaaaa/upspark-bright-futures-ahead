...
const Profile = () => {
  ...
  const { userRole, userPermissions } = useUserRole();
  ...
  const getAvailableTabs = () => {
    const allTabs = [
      { id: 'dashboard', icon: Home, label: 'Home', permission: 'canViewProfile' },
      { id: 'activities', icon: Activity, label: 'Activities', permission: 'canViewActivities' },
      { id: 'therapist', icon: UserCheck, label: 'Therapist', permission: 'canViewTherapist' },
      { id: 'medicine', icon: Pill, label: 'Medicine', permission: 'canViewMedicine' },
      { id: 'profile', icon: User, label: 'Profile', permission: 'canViewProfile' },
    ];

    return allTabs.filter(tab => userPermissions[tab.permission as keyof typeof userPermissions]);
  };
        ...
        return (
          <div className="space-y-8">
            <div className="bold-card p-8 rounded-3xl text-center">
              ...
              <h1 className="text-5xl mb-4 font-black text-white">Hey {childName}! 🌟</h1>
              <p className="text-3xl font-black text-white">Ready for some fun activities? 🎮</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <div className="text-4xl font-black text-white mb-2">Let's Play!</div>
                  <div className="text-xl font-black text-white mb-1">Fun Activities</div>
                  <div className="text-lg font-bold text-green-300">Games & Learning</div>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      case 'therapist':
        return (
          <div className="space-y-8">
            <div className="bold-card p-8 rounded-3xl text-center">
              <UpSparkLogo size="medium" className="mb-6" />
              <h1 className="text-5xl mb-4 font-black text-white">Therapist Dashboard 👩‍⚕️</h1>
              <p className="text-3xl font-black text-white">Manage your patients and sessions</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <div className="text-4xl font-black text-white mb-2">Sessions</div>
                  <div className="text-xl font-black text-white mb-1">Manage Bookings</div>
                  <div className="text-lg font-bold text-blue-300">Schedule & Track</div>
                </CardContent>
              </Card>
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <div className="text-xl font-black text-white mb-1">Patient Activities</div>
                  <div className="text-lg font-bold text-purple-300">Monitor Development</div>
                </CardContent>
              </Card>
            </div>
          </div>
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      ...
      case 'therapist':
        return userPermissions.canViewTherapist ? <TherapistBooking onPlanSelected={handlePlanSelected} /> : null;
      case 'medicine':
        return userPermissions.canViewMedicine ? <MedicineDelivery onUploadRequest={handleUploadRequest} /> : null;
      default:
        return userPermissions.canViewProfile ? (
          <div className="space-y-8">
            {/* Header */}
            ...
            {/* Current Plan Card */}
            {currentPlan.therapistName && userRole !== 'child' && (
              // ... keep existing current plan card content
            ...
            {userPermissions.canEditProfile && (
              // ... keep existing profile details card content
            ...
            {/* Document Verification Section - Only for parents and admins */}
